...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-6 text-xl", className)}
      classNames={{
        months: "flex flex-col sm:flex-row gap-6",
        month: "flex flex-col gap-10",
        caption: "flex justify-center pt-1 relative items-center w-full",
        caption_label: "text-sm font-medium",
        nav: "flex items-center gap-1",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "size-12 bg-transparent p-0 opacity-50 hover:opacity-100 text-xl"
        ),
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-12 font-normal text-lg",
        ...
        day: cn(
          ...
          "size-20 p-0 font-normal text-2xl aria-selected:opacity-100"
        ),
        day_range_start:
