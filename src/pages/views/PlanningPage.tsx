    ...
    React.useEffect(() => {
        const loadData = async () => {
            try {
                ...
                // Mapper toutes les tâches pour le calendrier
                const loadedTasks: TaskRow[] = projectsWithTasks.flatMap(
                    project =>
                        (Array.isArray(project.tasks) ? project.tasks : []).map(
                            (task: any) => ({
                                id: task.id,
                                name: task.name,
                                    ...
                                    <div className="w-full lg:w-5/5 space-y-4">
                                        ...
                                        {filteredTasks.length > 0 ? (
                                            ...
                                            <p className="text-muted-foreground text-sm">
                                                Aucune tâche prévue pour cette
                                                date
                                            </p>
                                        )}
                                    </div>
